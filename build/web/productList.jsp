            ...
            <header class="row bg-primary text-white py-3">
                <div class="col-md-3 d-flex align-items-center">
                    <a href="index.jsp" class="text-white">
                        <img src="https://png.pngtree.com/png-clipart/20200727/original/pngtree-smartphone-shop-sale-logo-design-png-image_5069958.jpg" width="30%">
                    </a>
                </div>
            ...
            <div class="row mt-4">
                <nav class="col-md-3 sidebar bg-light p-3">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="productList.jsp?category=Apple" class="d-flex align-items-center">
                        ...
                        <li>
                            <a href="productList.jsp?category=Samsung" class="d-flex align-items-center">
                                <img src="https://static.vecteezy.com/system/resources/thumbnails/007/167/605/small/smartphone-black-icon-on-white-background-free-vector.jpg" 
                                     alt="Samsung Icon" 
                                     class="icon" 
                                     style="width: 20px; margin-right: 8px;"> <!-- Icon cho Samsung -->
                                Samsung
                            </a>
                        </li>
                        <li>
                            <a href="productList.jsp?category=OPPO" class="d-flex align-items-center">
                                <img src="https://static.vecteezy.com/system/resources/thumbnails/007/167/605/small/smartphone-black-icon-on-white-background-free-vector.jpg" 
                                     alt="OPPO Icon" 
                                     class="icon" 
                        ...
                        <li>
                            <a href="productList.jsp?category=Vivo" class="d-flex align-items-center">
                                <img src="https://static.vecteezy.com/system/resources/thumbnails/007/167/605/small/smartphone-black-icon-on-white-background-free-vector.jpg" 
                                     alt="Vivo Icon" 
                                     class="icon" 
                        ...
                        <li>
                            <a href="productList.jsp?category=Tecno" class="d-flex align-items-center">
                                <img src="https://static.vecteezy.com/system/resources/thumbnails/007/167/605/small/smartphone-black-icon-on-white-background-free-vector.jpg" 
                                     alt="Tecno Icon" 
                                     class="icon" 
                        ...
                        <li>
                            <a href="productList.jsp?category=Realme" class="d-flex align-items-center">
                                <img src="https://static.vecteezy.com/system/resources/thumbnails/007/167/605/small/smartphone-black-icon-on-white-background-free-vector.jpg" 
                                     alt="Realme Icon" 
                                     class="icon" 
                                     style="width: 20px; margin-right: 8px;"> <!-- Icon cho Realme -->
                                Realme
                            </a>
                        </li>
                    </ul>
                ...
                <main class="col-md-9">
                    <div class="row">
                        <div class="col-12 mb-3 text-center"> <!-- Thêm text-center để căn giữa -->
                            <img src="https://www.xtsmart.vn/vnt_upload/news/11_2020/xtm-tt-sale-samsung-19-11.jpg" alt="Promotion Banner" class="img-fluid" style="width: 90%;">
                        </div>
                    </div>
                    <div class="row">
